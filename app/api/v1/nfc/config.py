...
from app.crud.nfc import get_nfc_by_item_id, update_nfc_url, get_click_stats
...
@router.put("/config/{item_id}", response_model=NFCConfigResponse)
def update_nfc_config(item_id: str, payload: NFCConfigUpdateRequest, db: Session = Depends(get_db)):
